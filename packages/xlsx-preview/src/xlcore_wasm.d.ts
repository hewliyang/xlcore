...
export class WorkbookHandle {
  ...
  setImage(patch: any): any;
  setPageSetup(sheet: string, patch: any): any;
  setPivot(patch: any): any;
...
export interface InitOutput {
  ...
  readonly workbookhandle_setChart: (a: number, b: number, c: number) => void;
  ...
  readonly workbookhandle_setImage: (a: number, b: number, c: number) => void;
  ...
  readonly workbookhandle_setPivot: (a: number, b: number, c: number) => void;
  ...
  readonly workbookhandle_setShape: (a: number, b: number, c: number) => void;
