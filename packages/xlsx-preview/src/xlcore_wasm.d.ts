...
export class WorkbookHandle {
    ...
    copyRange(src_sheet: string, src_reference: string, dst_sheet: string, dst_reference: string): any;
    ...
    moveRange(src_sheet: string, src_reference: string, dst_sheet: string, dst_reference: string): any;
    ...
    updateChartEx(sheet: string, id: string, update: any): any;
...
export interface InitOutput {
    ...
    readonly workbookhandle_clearRange: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly workbookhandle_clearRangeWith: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly workbookhandle_clearWith: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    ...
    readonly workbookhandle_copyRange: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
    ...
    readonly workbookhandle_dependencies: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly workbookhandle_getRange: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly workbookhandle_moveRange: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => void;
    ...
    readonly workbookhandle_precedents: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    ...
    readonly workbookhandle_setFormula: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => void;
    ...
    readonly workbookhandle_setStyle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly workbookhandle_setTable: (a: number, b: number, c: number, d: number, e: number) => void;
    readonly workbookhandle_setValue: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    ...
    readonly workbookhandle_updateChartEx: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
    readonly workbookhandle_updateImage: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
