export type World110mGeometry =
  | { type: "Polygon"; coordinates: number[][][] }
  | { type: "MultiPolygon"; coordinates: number[][][][] };

export interface World110mFeature {
  n: string | null;
...
export const WORLD_110M_FEATURES: World110mFeature[] = [
  {
    n: "Fiji",
    nl: "Fiji",
    a2: "FJ",
  ...
  },
  {
    ...
    nl: "French Southern and Antarctic Lands",
    a2: "TF",
    a3: "ATF",
    g: {
      type: "Polygon",
