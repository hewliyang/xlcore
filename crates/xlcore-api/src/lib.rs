...
pub use xlcore_types::{
    ...
    ChartStacking, ChartUpdate, ClearMode, ColorScalePatch, CommentInfo, CommentPatch,
    ConditionalFormatRuleInfo, ConditionalFormatRulePatch, CrossBetween, DataBarPatch,
    ...
    DispBlanksAs, FillPatch, FontPatch, FontScheme, FreezeInfo, GradientFillPatch,
    GradientStopPatch, GradientType, HeaderFooterInfo, HeaderFooterPatch, HorizontalAlign,
    HyperlinkInfo, HyperlinkPatch, IconSetPatch, ImageFormat, ImageInfo, ImagePatch, ImageUpdate,
    LayoutOptions, LineDash, MarkerStyle, MergeInfo, NamedStyleInfo, NamedStylePatch,
    PageMarginsInfo, PageMarginsPatch, PageOrder, PageOrientation, PageSetupSettings,
    PageSetupSettingsPatch, PatternType, PivotAggregation, PivotCellRole, PivotDataField,
