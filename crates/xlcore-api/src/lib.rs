...
pub use xlcore_types::{
    ...
    ChartSeriesPatch, ChartStacking, ChartUpdate, ClearMode, ColorScalePatch, CommentInfo,
    CommentPatch, ConditionalFormatRuleInfo, ConditionalFormatRulePatch, CrossBetween,
    DataBarPatch, DataValidationErrorStyle, DataValidationInfo, DataValidationOperator,
    DataValidationPatch, DataValidationType, DefinedNameInfo, DefinedNamePatch, DependencyInfo,
    DependencyReference, FillPatch, FontPatch, FreezeInfo, HeaderFooterInfo, HeaderFooterPatch,
    HorizontalAlign, HyperlinkInfo, HyperlinkPatch, IconSetPatch, ImageFormat, ImageInfo,
    ImagePatch, LayoutOptions, MergeInfo, PageMarginsInfo, PageMarginsPatch, PageOrder,
    PageOrientation, PageSetupSettings, PageSetupSettingsPatch, PivotAggregation, PivotCellRole,
    ...
    SearchMatch, SearchMode, SearchOptions, SearchTarget, ShapeInfo, ShapeLineEnd, ShapePatch,
    SheetInfo, SheetPageSetup, SheetPageSetupPatch, SheetProtectionInfo, SheetProtectionPatch,
