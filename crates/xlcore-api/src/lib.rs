...
pub use xlcore_types::{
    ...
    PageSetupSettingsPatch, PivotAggregation, PivotCellRole, PivotDataField, PivotGrid,
    PivotGridCell, PivotInfo, PivotPatch, PrintCellComments, PrintErrors, PrintOptionsInfo,
    PrintOptionsPatch, RangeInfo, SearchHit, SearchMatch, SearchMode, SearchOptions, SearchTarget,
