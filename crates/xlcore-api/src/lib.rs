...
pub use xlcore_types::{
    ...
    ChartAxisGroup, ChartAxisPatch, ChartInfo, ChartKind, ChartLegendPosition, ChartMarker,
    ChartPatch, ChartSeriesInfo, ChartSeriesPatch, ChartStacking, ChartUpdate, ClearMode,
    ColorScalePatch, CommentInfo, CommentPatch, ConditionalFormatRuleInfo,
    ...
    HyperlinkPatch, IconSetPatch, ImageFormat, ImageInfo, ImagePatch, LayoutOptions, MarkerStyle,
