...
pub use xlcore_types::{
    ...
    ChartAxisGroup, ChartAxisPatch, ChartExInfo, ChartExKind, ChartExPatch, ChartExQuartileMethod,
    ChartExSeriesInfo, ChartExSeriesPatch, ChartExUpdate, ChartInfo, ChartKind,
    ChartLegendPosition, ChartLine,
    ...
    HyperlinkPatch, IconSetPatch, ImageFormat, ImageInfo, ImagePatch, ImageUpdate, LayoutOptions,
    LineDash,
    MarkerStyle, MergeInfo, NamedStyleInfo, NamedStylePatch, PageMarginsInfo, PageMarginsPatch,
    PageOrder, PageOrientation, PageSetupSettings, PageSetupSettingsPatch, PatternType,
    PivotAggregation, PivotCellRole, PivotDataField, PivotFieldFilter, PivotGrid, PivotGridCell,
    PivotInfo, PivotPatch, PivotUpdate, PrintCellComments, PrintErrors, PrintOptionsInfo,
    PrintOptionsPatch, ProtectionPatch, RadarStyle, RangeInfo, ReadingOrder, RichText, RichTextRun,
    ...
    SheetPropertiesPatch, SheetProtectionInfo, SheetProtectionPatch, SheetVisibility,
    ...
    ThreadedNotePatch, TickLabelPosition, TickMark, UnderlinePatch, VertAlign, VerticalAlign,
