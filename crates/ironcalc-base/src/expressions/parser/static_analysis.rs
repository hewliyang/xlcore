...
fn get_function_args_signature(kind: &Function, arg_count: usize) -> Vec<Signature> {
    match kind {
        ...
        Function::Usdollar => args_signature_scalars(arg_count, 1, 1),
        Function::Lenb => args_signature_scalars(arg_count, 1, 0),
        Function::Leftb => args_signature_scalars(arg_count, 1, 1),
        Function::Rightb => args_signature_scalars(arg_count, 2, 1),
        ...
        Function::Randarray => args_signature_scalars(arg_count, 0, 5),
        Function::Frequency => vec![Signature::Vector; arg_count],
        Function::Textsplit => vec![Signature::Scalar; arg_count],
        Function::ModeMult => vec![Signature::Vector; arg_count],
        Function::Linest => vec![Signature::Vector; arg_count],
        ...
        Function::Map => vec![Signature::Vector; arg_count],
        Function::Reduce => vec![Signature::Vector; arg_count],
        Function::Scan => vec![Signature::Vector; arg_count],
        Function::Byrow => vec![Signature::Vector; arg_count],
        Function::Bycol => vec![Signature::Vector; arg_count],
        Function::Makearray => vec![Signature::Vector; arg_count],
        Function::Sort => {
            let mut result = vec![Signature::Vector; arg_count];
        ...
        Function::Filter => {
            let mut result = vec![Signature::Vector; arg_count];
            for item in result.iter_mut().skip(2) {
                *item = Signature::Scalar;
            }
            result
        }
        ...
        Function::Mmult | Function::Minverse | Function::Munit => {
            vec![Signature::Vector; arg_count]
        }
        ...
        Function::EcmaCeiling => args_signature_scalars(arg_count, 1, 1),
        ...
        Function::StDevLegacy => vec![Signature::Vector; arg_count],
        Function::StDevPLegacy => vec![Signature::Vector; arg_count],
        Function::VarLegacy => vec![Signature::Vector; arg_count],
        Function::VarPLegacy => vec![Signature::Vector; arg_count],
        Function::RankLegacy => vec![Signature::Scalar, Signature::Vector, Signature::Scalar],
        Function::TDistLegacy => args_signature_scalars(arg_count, 3, 0),
        Function::ModeSngl => vec![Signature::Vector; arg_count],
        Function::Mode => vec![Signature::Vector; arg_count],
        ...
        Function::PercentRankLegacy | Function::PercentRankInc | Function::PercentRankExc => {
            if arg_count == 2 {
                vec![Signature::Vector, Signature::Scalar]
            } else if arg_count == 3 {
                vec![Signature::Vector, Signature::Scalar, Signature::Scalar]
...
fn static_analysis_on_function(kind: &Function, args: &[Node]) -> StaticResult {
    match kind {
        ...
        Function::Jis => not_implemented(args),
        ...
        Function::Usdollar => not_implemented(args),
        ...
        Function::Minverse => not_implemented(args),
        Function::Munit => not_implemented(args),
        Function::Aggregate => not_implemented(args),
        Function::Rand => not_implemented(args),
        Function::Randarray => not_implemented(args),
        Function::Frequency => not_implemented(args),
        Function::Textsplit => not_implemented(args),
        Function::ModeMult => not_implemented(args),
        Function::Linest => not_implemented(args),
        ...
        Function::Map => not_implemented(args),
        Function::Reduce => not_implemented(args),
        Function::Scan => not_implemented(args),
        Function::Byrow => not_implemented(args),
        Function::Bycol => not_implemented(args),
        Function::Makearray => not_implemented(args),
        ...
        Function::EcmaCeiling => scalar_arguments(args),
        ...
        Function::StDevLegacy => StaticResult::Scalar,
        Function::StDevPLegacy => StaticResult::Scalar,
        Function::VarLegacy => StaticResult::Scalar,
        Function::VarPLegacy => StaticResult::Scalar,
        Function::RankLegacy => StaticResult::Scalar,
        Function::TDistLegacy => StaticResult::Scalar,
        Function::ModeSngl => StaticResult::Scalar,
        Function::Mode => StaticResult::Scalar,
        ...
        Function::PercentRankLegacy => StaticResult::Scalar,
        ...
        Function::Forecast | Function::ForecastLinear => StaticResult::Scalar,
