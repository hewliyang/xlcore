    ...
    ($($field:ident => $variant:ident),+ $(,)?) => {
        impl Functions {
            pub fn lookup(&self, name: &str) -> Option<Function> {
                ...
                if key == "SUMPRODUCT" {
                    return Some(Function::Sumproduct);
                }
                $(
                    if self.$field == key {
...
impl_function_lookup! {
    ...
    normsdist      => NormSdist,
    normsinv       => NormSInv,
    normdistlegacy => NormDistLegacy,
    norminvlegacy  => NormInvLegacy,
    normsdistlegacy => NormSDistLegacy,
    normsinvlegacy => NormSInvLegacy,
    pearson        => Pearson,
    phi            => Phi,
    ...
    stdevp         => StDevP,
    stdevs         => StDevS,
    stdevlegacy    => StDevLegacy,
    stdevplegacy   => StDevPLegacy,
    varlegacy      => VarLegacy,
    ...
    tinv2t         => TInv2T,
    ttest          => TTest,
    chidistlegacy  => ChiDistLegacy,
    chiinvlegacy   => ChiInvLegacy,
    chitestlegacy  => ChiTestLegacy,
    fdistlegacy    => FDistLegacy,
    finvlegacy     => FInvLegacy,
    ftestlegacy    => FTestLegacy,
    tinvlegacy     => TInvLegacy,
    ttestlegacy    => TTestLegacy,
    betadistlegacy => BetaDistLegacy,
    betainvlegacy  => BetaInvLegacy,
    binomdistlegacy => BinomDistLegacy,
    critbinomlegacy => CritBinomLegacy,
    confidencelegacy => ConfidenceLegacy,
    covarlegacy    => CovarLegacy,
    expondistlegacy => ExponDistLegacy,
    gammadistlegacy => GammaDistLegacy,
    gammainvlegacy => GammaInvLegacy,
    hypgeomdistlegacy => HypGeomDistLegacy,
    loginvlegacy   => LogInvLegacy,
    lognormdistlegacy => LogNormDistLegacy,
    negbinomdistlegacy => NegBinomDistLegacy,
    poissonlegacy  => PoissonLegacy,
    weibulllegacy  => WeibullLegacy,
    ztestlegacy    => ZTestLegacy,
    percentilelegacy => PercentileLegacy,
...
impl Function {
    pub fn to_localized_name(&self, language: &Language) -> String {
        ...
        match self {
            ...
            Function::EcmaCeiling => functions.ecmaceiling.clone(),
            ...
            Function::Usdollar => functions.usdollar.clone(),
            ...
            Function::NormDistLegacy => functions.normdistlegacy.clone(),
            Function::NormInvLegacy => functions.norminvlegacy.clone(),
            Function::NormSDistLegacy => functions.normsdistlegacy.clone(),
            Function::NormSInvLegacy => functions.normsinvlegacy.clone(),
            ...
            Function::StDevLegacy => functions.stdevlegacy.clone(),
            Function::StDevPLegacy => functions.stdevplegacy.clone(),
            ...
            Function::ChiDistLegacy => functions.chidistlegacy.clone(),
            Function::ChiInvLegacy => functions.chiinvlegacy.clone(),
            Function::ChiTestLegacy => functions.chitestlegacy.clone(),
            Function::FDistLegacy => functions.fdistlegacy.clone(),
            Function::FInvLegacy => functions.finvlegacy.clone(),
            Function::FTestLegacy => functions.ftestlegacy.clone(),
            Function::TInvLegacy => functions.tinvlegacy.clone(),
            Function::TTestLegacy => functions.ttestlegacy.clone(),
            Function::BetaDistLegacy => functions.betadistlegacy.clone(),
            Function::BetaInvLegacy => functions.betainvlegacy.clone(),
            Function::BinomDistLegacy => functions.binomdistlegacy.clone(),
            Function::CritBinomLegacy => functions.critbinomlegacy.clone(),
            Function::ConfidenceLegacy => functions.confidencelegacy.clone(),
            Function::CovarLegacy => functions.covarlegacy.clone(),
            Function::ExponDistLegacy => functions.expondistlegacy.clone(),
            Function::GammaDistLegacy => functions.gammadistlegacy.clone(),
            Function::GammaInvLegacy => functions.gammainvlegacy.clone(),
            Function::HypGeomDistLegacy => functions.hypgeomdistlegacy.clone(),
            Function::LogInvLegacy => functions.loginvlegacy.clone(),
            Function::LogNormDistLegacy => functions.lognormdistlegacy.clone(),
            Function::NegBinomDistLegacy => functions.negbinomdistlegacy.clone(),
            Function::PoissonLegacy => functions.poissonlegacy.clone(),
            Function::WeibullLegacy => functions.weibulllegacy.clone(),
            Function::ZTestLegacy => functions.ztestlegacy.clone(),
            Function::PercentileLegacy => functions.percentilelegacy.clone(),
    ...
    pub fn into_iter() -> IntoIter<Function, 436> {
        [
            ...
            Function::NormSdist,
            Function::NormSInv,
            Function::NormDistLegacy,
            Function::NormInvLegacy,
            Function::NormSDistLegacy,
            Function::NormSInvLegacy,
            Function::Pearson,
            Function::Phi,
            ...
            Function::StDevP,
            Function::StDevS,
            Function::StDevLegacy,
            Function::StDevPLegacy,
            Function::VarLegacy,
            Function::VarPLegacy,
            Function::RankLegacy,
            ...
            Function::TInv2T,
            Function::TTest,
            Function::ChiDistLegacy,
            Function::ChiInvLegacy,
            Function::ChiTestLegacy,
            Function::FDistLegacy,
            Function::FInvLegacy,
            Function::FTestLegacy,
            Function::TInvLegacy,
            Function::TTestLegacy,
            Function::BetaDistLegacy,
            Function::BetaInvLegacy,
            Function::BinomDistLegacy,
            Function::CritBinomLegacy,
            Function::ConfidenceLegacy,
            Function::CovarLegacy,
            Function::ExponDistLegacy,
            Function::GammaDistLegacy,
            Function::GammaInvLegacy,
            Function::HypGeomDistLegacy,
            Function::LogInvLegacy,
            Function::LogNormDistLegacy,
            Function::NegBinomDistLegacy,
            Function::PoissonLegacy,
            Function::WeibullLegacy,
...
impl Function {
    ...
    pub fn to_xlsx_string(&self) -> String {
        match self {
            ...
            Function::NormDistLegacy => "NORMDIST".to_string(),
            Function::NormInvLegacy => "NORMINV".to_string(),
            Function::NormSDistLegacy => "NORMSDIST".to_string(),
            Function::NormSInvLegacy => "NORMSINV".to_string(),
            ...
            Function::StDevLegacy => "STDEV".to_string(),
            Function::StDevPLegacy => "STDEVP".to_string(),
            ...
            Function::ChiDistLegacy => "CHIDIST".to_string(),
            Function::ChiInvLegacy => "CHIINV".to_string(),
            Function::ChiTestLegacy => "CHITEST".to_string(),
            Function::FDistLegacy => "FDIST".to_string(),
            Function::FInvLegacy => "FINV".to_string(),
            Function::FTestLegacy => "FTEST".to_string(),
            Function::TInvLegacy => "TINV".to_string(),
            Function::TTestLegacy => "TTEST".to_string(),
            Function::BetaDistLegacy => "BETADIST".to_string(),
            Function::BetaInvLegacy => "BETAINV".to_string(),
            Function::BinomDistLegacy => "BINOMDIST".to_string(),
            Function::CritBinomLegacy => "CRITBINOM".to_string(),
            Function::ConfidenceLegacy => "CONFIDENCE".to_string(),
            Function::CovarLegacy => "COVAR".to_string(),
            Function::ExponDistLegacy => "EXPONDIST".to_string(),
            Function::GammaDistLegacy => "GAMMADIST".to_string(),
            Function::GammaInvLegacy => "GAMMAINV".to_string(),
            Function::HypGeomDistLegacy => "HYPGEOMDIST".to_string(),
            Function::LogInvLegacy => "LOGINV".to_string(),
            Function::LogNormDistLegacy => "LOGNORMDIST".to_string(),
            Function::NegBinomDistLegacy => "NEGBINOMDIST".to_string(),
            Function::PoissonLegacy => "POISSON".to_string(),
            Function::WeibullLegacy => "WEIBULL".to_string(),
            Function::ZTestLegacy => "ZTEST".to_string(),
            Function::PercentileLegacy => "PERCENTILE".to_string(),
...
impl<'a> Model<'a> {
    pub(crate) fn evaluate_function(
        ...
        match kind {
            ...
            Function::Usdollar => self.fn_dollar(args, cell),
            ...
            Function::EcmaCeiling => self.fn_iso_ceiling(args, cell),
            ...
            Function::NormDistLegacy => self.fn_norm_dist(args, cell),
            Function::NormInvLegacy => self.fn_norm_inv(args, cell),
            Function::NormSDistLegacy => self.fn_normsdist_legacy(args, cell),
            Function::NormSInvLegacy => self.fn_norm_s_inv(args, cell),
            ...
            Function::StDevLegacy => self.fn_stdev_s(args, cell),
            Function::StDevPLegacy => self.fn_stdev_p(args, cell),
            ...
            Function::ChiDistLegacy => self.fn_chisq_dist_rt(args, cell),
            Function::ChiInvLegacy => self.fn_chisq_inv_rt(args, cell),
            Function::ChiTestLegacy => self.fn_chisq_test(args, cell),
            Function::FDistLegacy => self.fn_f_dist_rt(args, cell),
            Function::FInvLegacy => self.fn_f_inv_rt(args, cell),
            Function::FTestLegacy => self.fn_f_test(args, cell),
            Function::TInvLegacy => self.fn_t_inv_2t(args, cell),
            Function::TTestLegacy => self.fn_t_test(args, cell),
            Function::BetaDistLegacy => self.fn_betadist_legacy(args, cell),
            Function::BetaInvLegacy => self.fn_beta_inv(args, cell),
            Function::BinomDistLegacy => self.fn_binom_dist(args, cell),
            Function::CritBinomLegacy => self.fn_binom_inv(args, cell),
            Function::ConfidenceLegacy => self.fn_confidence_norm(args, cell),
            Function::CovarLegacy => self.fn_covariance_p(args, cell),
            Function::ExponDistLegacy => self.fn_expon_dist(args, cell),
            Function::GammaDistLegacy => self.fn_gamma_dist(args, cell),
            Function::GammaInvLegacy => self.fn_gamma_inv(args, cell),
            Function::HypGeomDistLegacy => self.fn_hypgeomdist_legacy(args, cell),
            Function::LogInvLegacy => self.fn_log_norm_inv(args, cell),
            Function::LogNormDistLegacy => self.fn_lognormdist_legacy(args, cell),
            Function::NegBinomDistLegacy => self.fn_negbinomdist_legacy(args, cell),
            Function::PoissonLegacy => self.fn_poisson_dist(args, cell),
            Function::WeibullLegacy => self.fn_weibull_dist(args, cell),
            Function::ZTestLegacy => self.fn_z_test(args, cell),
            Function::PercentileLegacy => self.fn_percentile_inc(args, cell),
