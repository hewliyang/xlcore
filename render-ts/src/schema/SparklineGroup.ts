 ...
 */
lineWeight: number, markers: boolean, high: boolean, low: boolean, first: boolean, last: boolean, negative: boolean, 
/**
 * `displayXAxis=1` paints a horizontal axis line at zero when the
 * data crosses zero. (Excel calls this "Show Axis".)
 */
displayXAxis: boolean, rightToLeft: boolean, 
/**
 ...
 */
minAxisType: string, maxAxisType: string, 
/**
 * Set when `min_axis_type == "custom"`.
 */
manualMin?: number, manualMax?: number, 
/**
 ...
 */
colorSeries?: string, colorNegative?: string, colorAxis?: string, colorMarkers?: string, colorFirst?: string, colorLast?: string, colorHigh?: string, colorLow?: string, 
/**
